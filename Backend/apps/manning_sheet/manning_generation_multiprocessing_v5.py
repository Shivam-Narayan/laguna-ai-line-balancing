...
def process_manning_dataframe_parallel(manning_df, emp_fact_df, period, max_workers=None):
    ...
    try:
        ...
        print(f"Error in process_manning_dataframe_parallel function: {e}")
...
def process_date(date, manning_df, emp_fact_df, period):
    ...
    try:
        ...
        print(f"Error in process_date function: {e}")
...
def get_employee_allocation_details(emp_id, employee_used_capacity, emp_fact_df):
    ...
    try:
        ...
        print(f"Error in get_employee_allocation_details function: {e}")
...
def process_period(df_manning, period, reference_data):
    try:
        ...
        print(f"Error in process_period function: {e}")
...
def process_general_info(df_manning, df_emp_fact, period):
    try:
        ...
        print(f"Error in process_general_info function: {e}")