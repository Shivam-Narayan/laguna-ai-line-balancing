...
def get_prioritized_employees(emp_df, line=None, factory=None, floor=None, code=None, emp_type=None):
    """
...
def find_preferred_employees(emp_fact_df, code=None, line=None, factory=None, floor=None, current_emp_id=None):
    """
...
def get_prioritized_employees_old(emp_df, capacity_tracker, line=None, factory=None, floor=None, code=None, section=None, emp_type=None, designation=None):
    """
...
def find_preferred_employees_old(emp_fact_df, capacity_tracker, code=None, line=None, factory=None, floor=None, current_emp_id=None):
    """
    Find preferred employees using the same prioritization logic as get_prioritized_employees
    Returns a comma-separated string of employee names with their line
    Now also includes unassigned employees with matching skills
...
def reallocate_work_enhanced_old(affected_allocations, emp_fact_df, allocation_date, wip_df=None, emp_type=None):
    """
...
def balance_by_operation_sequence_enhanced_old(planned_manning_df, emp_fact_df, wip_df=None):
    """
    Enhanced balancing function that considers WIP ratios, minimum staffing, and optimal buffers
