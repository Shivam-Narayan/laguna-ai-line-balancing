...
class LoadingPlan(BaseModel):
    ...
    line = models.CharField(max_length=255, db_index=True)
    ...
    planned_dates = models.DateField(null=True, blank=True, db_index=True)
...
class ManningSheetData(BaseModel):
    ...
    line = models.CharField(max_length=255, db_index=True)
    week = models.IntegerField()
    planned_dates = models.DateField(db_index=True)
    planned_qty = models.FloatField()
    ...
    allocated_emp_id = models.IntegerField(db_index=True)
...
class DDayData(BaseModel):
    ...
    line = models.CharField(max_length=255, db_index=True)
    week = models.IntegerField()
    planned_dates = models.DateTimeField(db_index=True)
    planned_qty = models.FloatField()
    factory = models.CharField(max_length=255)
    floor = models.CharField(max_length=255)
    workdays = models.IntegerField()
    ...
    sam = models.FloatField()
    allocated_emp_id = models.IntegerField(null=True, blank=True, db_index=True)
    allocated_emp_name = models.CharField(max_length=255, null=True, blank=True)
    allocated_capacity = models.FloatField(null=True, blank=True)
    allocated_frm_line = models.CharField(max_length=255, null=True, blank=True)
    allocated_frm_factory = models.CharField(max_length=255, null=True, blank=True)
