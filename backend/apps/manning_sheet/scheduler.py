...
def start():
    ...
    if not scheduler_started:
        ...
        scheduler.add_job(
            run_generate_style_ob,
            CronTrigger(
                hour=7, minute=45, day_of_week="mon-sat", timezone=ist
            ),  # 07:30 (7:45 AM) Monday to Saturday
        ...
        scheduler.add_job(
            run_manning_generation,
            CronTrigger(
                hour=8, minute=0, day_of_week="mon", timezone=ist
            ),  # 08:00 (8:00 AM) Monday to Saturday #added day_of_week='mon' to run only on Mondays
        ...
        scheduler.add_job(
            run_dday_generation,
            CronTrigger(
                hour=8, minute=50, day_of_week="mon-sat", timezone=ist
            ),  # 08:50 (8:50 AM) Monday to Saturday
        ...
        scheduler.add_job(
            run_dday_generation,
            CronTrigger(
                hour=12, minute=45, day_of_week="mon-sat", timezone=ist
            ),  # 12:45 (12:45 PM) Monday to Saturday
        ...
        scheduler.add_job(
            run_dday_generation,
            CronTrigger(
                hour=17, minute=30, day_of_week="mon-sat", timezone=ist
            ),  # 17:30 (05:30 PM) Monday to Saturday
        ...
        scheduler.add_job(
            fetch_and_transform_empdetails,
            CronTrigger(
                hour=21, minute=45, day_of_week="mon-sat", timezone=ist
            ),  # 21:45 (09:45 PM) Monday to Saturday
        ...
        scheduler.add_job(
            run_generate_emp_fact,
            CronTrigger(
                hour=22, minute=0, day_of_week="mon-sat", timezone=ist
            ),  # 22:00 (10:00 PM) Monday to Saturday
        ...
        scheduler.add_job(
            delete_old_exported_files,
            CronTrigger(
                hour=9, minute=0, day_of_week="sun", timezone=ist
            ),  # 09:00 (09:00 AM) Every Sunday
