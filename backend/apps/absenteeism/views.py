...
from .services.prediction_orchestrator import run_absenteeism_prediction, prepare_prediction_data, run_get_absenteeism_forecast, run_absenteeism_prediction_trigger, run_absenteeism_prediction_data
from .services.report_service import run_absenteeism_report, save_absenteeism_report, fetch_absenteeism_report_data, absenteeism_report
...
def absenteeism_prediction_data(request):
    ...
    return run_absenteeism_prediction_data(line_no, forecast_period, get_all, is_export, export_type, email)
